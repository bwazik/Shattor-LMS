        ...
        switch ($template) {
            ...
            case 'fees_paid':
                return "السلام عليكم 👋🏻\n"
                    ...
                    . "⚠️ تنبيه هام:\n"
                    . "لضمان استمرار استلام إشعارات الدفع والمتابعة الخاصة بالطالب، يجب إرسال كلمة (تمام) لتأكيد استلام الرسالة.\n"
                    . "في حالة عدم إرسال كلمة (تمام)، سيتم إيقاف الإشعارات تلقائيًا، ولن تستقبلوا أي رسائل تخص الطالب حتى يتم التأكيد.";
            ...
            case 'student_absence_notification':
                ...
                return "السلام عليكم 👋🏻\n\n"
                    ...
                    . "⚠️ تنبيه هام:\n"
                    . "لضمان استمرار استلام إشعارات الغياب الخاصة بالطالب، يجب إرسال كلمة (تمام) لتأكيد استلام الرسالة.\n"
                    . "في حالة عدم إرسال كلمة (تمام)، سيتم إيقاف الإشعارات تلقائيًا، ولن تستقبلوا أي رسائل تخص المتابعة حتى يتم التأكيد.";
            ...
            case 'parent_portal_announcement':
                return "📢 تنبيه مهم لأولياء الأمور\n\n"
                    ...
                    . "هتدخل باستخدام:\n"
                    . "• رقم الطالب\n"
                    . "• رقم موبايل ولي الأمر المسجّل عندنا\n\n"
                    . "🌐 لينك المتابعة:\n"
                    . "https://shattor.com/ar/parent/login\n\n"
