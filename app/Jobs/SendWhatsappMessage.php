        ...
        switch ($template) {
            ...
            case 'fees_paid':
                $endings = [
                    ...
                    "تقديرنا لتعاونكم المستمر 🌼",
                    "نتمنى دوام التواصل والتوفيق 🤝",
                    "دمتم بخير وبأفضل حال 🌸",
                    "نقدّر متابعتكم المستمرة 🌺",
                    "جزيل الشكر لحسن تعاونكم 🌹",
                    "نتمنى لكم يومًا سعيدًا 🌞",
                    "شاكرين اهتمامكم وثقتكم في المنصة 🙏",
                    "مع خالص التحية والتقدير 💐",
                    "نسعد دائمًا بتعاونكم المثمر 🤝",
                    "نتمنى لحضرتكم دوام الصحة والعافية 🌿",
                    "جزيل الشكر لتعاونكم الكريم 🌷",
                    "كل التقدير لحرصكم ومتابعتكم 🌸",
                    "يسعدنا تواصلكم المستمر 🌼",
                    "دمتم في رعاية الله وحفظه 🌿",
                    "نعتز بتعاونكم الدائم معنا 💚",
                    "كل الشكر لحضرتكم على المتابعة 🙏",
                    "تمنياتنا بدوام التوفيق والنجاح 🌟",
                    "نشكركم على تعاونكم واهتمامكم المستمر 🌷",
                ];
                ...
                return "السلام عليكم 👋🏻\n"
                    ...
                    . "⚠️ هذه الرسالة تم إرسالها آليًا من نظام المتابعة، ولا يمكن الرد عليها بالاستفسارات.\n\n"
                    . "لو الرسالة وصلت، رد بـ (تمام) علشان نأكد إن كل حاجة واضحة 🙏\n\n"
                    . "{$ending}";
            ...
            case 'student_absence_notification':
                $lessonWord = $data['lesson_count'] == 1
                    ? 'حصة'
                    : ($data['lesson_count'] == 2
                        ? 'حصتين'
                        : "{$data['lesson_count']} حصص");
                ...
                return "السلام عليكم 👋🏻\n\n"
                    ...
                    . "⚠️ هذه الرسالة تم إرسالها آليًا من نظام المتابعة، ولا يمكن الرد عليها بالاستفسارات.\n\n"
                    . "لو الرسالة وصلت، رد بـ (تمام) علشان نأكد استلام الإشعار 🙏\n\n"
                    . "{$ending}";
