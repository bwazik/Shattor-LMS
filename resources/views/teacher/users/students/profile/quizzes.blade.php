...
@section('profile-content')
    ...
    <x-datatable id="quizzes-datatable" cardClasses="mb-6" datatableTitle="{{ trans('admin/quizzes.quizzes') }}">
        <th></th>
        <th>#</th>
...
@section('profile-js')
    <script>
        initializeDataTable('#quizzes-datatable', "{{ route('teacher.students.profile.quizzes', $student->uuid) }}?table=quizzes", [1, 2, 3, 4, 5 ,6],
            [
