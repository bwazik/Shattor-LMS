<!-- Add Offcanvas -->
<x-offcanvas offcanvasType="add" offcanvasTitle="{{ trans('main.addItem', ['item' => trans('admin/zooms.zoom')]) }}" action="{{ route('teacher.zooms.insert') }}">
...
<!-- Edit Offcanvas -->
<x-offcanvas offcanvasType="edit" offcanvasTitle="{{ trans('main.editItem', ['item' => trans('admin/zooms.zoom')]) }}" action="{{ route('teacher.zooms.update') }}" id meeting_id>
    <x-select-input context="offcanvas" name="grade_id" label="{{ trans('main.grade') }}" :options="$grades" required/>
...
<x-modal modalType="delete" modalTitle="{{ trans('main.deleteItem', ['item' => trans('admin/zooms.zoom')]) }}"
    action="{{ route('teacher.zooms.delete') }}" id meeting_id submitColor="danger" submitButton="{{ trans('main.yes_delete') }}">
    @include('partials.delete-modal-body')
</x-modal>
<!-- Delete Selected Modal -->
<x-modal modalType="delete-selected" modalTitle="{{ trans('main.deleteItem', ['item' => trans('admin/zooms.selectedZooms')]) }}"
    action="{{ route('teacher.zooms.deleteSelected') }}" ids submitColor="danger" submitButton="{{ trans('main.yes_delete') }}">
    @include('partials.delete-modal-body')
</x-modal>
