    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            initializeDataTable('#students-taken-quiz-datatable',
                "{{ route('teacher.offline-quizzes.studentsTakenOfflineQuiz', $offlineQuiz->uuid) }}", [0, 1, 2],
                [{
                    data: "",
                    orderable: false,
                    searchable: false
            ...
            initializeDataTable('#students-not-taken-quiz-datatable',
                "{{ route('teacher.offline-quizzes.studentsNotTakenOfflineQuiz', $offlineQuiz->uuid) }}", [0, 1, 2],
                [{
                    data: "",
                    orderable: false,
                    searchable: false
