...
@section('content')
    ...
    @include('teacher.activities.offline-quizzes.modals')
    <!--/ DataTable with Buttons -->
@endsection

@section('page-js')
    <script>
        initializeDataTable('#datatable', "{{ route('teacher.offline-quizzes.index') }}", [2, 3, 4, 5, 6, 7],
            [
        ...
        let fields = ['name_ar', 'name_en', 'grade_id', 'type', 'score', 'conducted_at'];
