...
@section('content')
    ...
    <div class="row mb-6">
        ...
        <div class="col-md-5 mb-6">
            <x-datatable id="students-without-fee-datatable" datatableTitle="{{ trans('admin/fees.studentsWithoutFee') }}">
                <th></th>
                <th>#</th>
                <th>{{ trans('main.student') }}</th>
                <th>{{ trans('main.created_at') }}</th>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            initializeDataTable('#students-paid-fee-datatable',
                "{{ route('teacher.fees.studentsPaidFee', $fee->uuid) }}", [1, 2, 3, 4, 5],
                [{
                        data: "",
                        orderable: false,
                        searchable: false
            ...
            initializeDataTable('#students-havenot-paid-fee-datatable',
                "{{ route('teacher.fees.studentsHavenotPaidFee', $fee->uuid) }}", [1, 2, 3, 4, 5],
                [{
                        data: "",
                        orderable: false,
                        searchable: false
            ...
            initializeDataTable('#students-without-fee-datatable',
                "{{ route('teacher.fees.studentsWithoutFee', $fee->uuid) }}", [1, 2, 3],
                [{
                        data: "",
                        orderable: false,
                        searchable: false
