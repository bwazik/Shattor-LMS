...
@section('content')
    <div class="row invoice-preview">
            ...
            <div class="card invoice-preview-card p-sm-12 p-6">
                <div class="card-body invoice-preview-header rounded-4 p-6">
                    <div
                        ...
                        <div>
                            <h5 class="mb-6">{{ trans('admin/invoices.theInvoice') }} #{{ substr($invoice->uuid, 14, 4) }}</h5>
                            <div class="mb-2">
        ...
        <div class="col-xl-3 col-md-4 col-12 invoice-actions">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('teacher.invoices.edit', $invoice->uuid) }}" id="print" class="btn btn-primary d-grid w-100 mb-4">
                        <span class="d-flex align-items-center justify-content-center text-nowrap">{{ trans('main.edit') }}</span>
                    </a>
                    <div class="d-flex">
                        <a target="_blank" href="{{ route('teacher.invoices.print', $invoice->uuid) }}" class="btn btn-outline-secondary d-grid w-100 me-4 waves-effect text-nowrap">
                            {{ trans('main.print') }}
                        </a>
