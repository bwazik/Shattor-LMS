...
@section('content')
    <h4 class="mb-5">{{ $lesson->title }} - {{ $lesson->group->grade->name }}</h4>
    <!-- Stats -->
    <div class="row mb-6">
...
@section('page-js')
    ...
    <script>
        ...
        initializeDataTable('#absent-students-datatable', "{{ route('teacher.lessons.absent', $lesson->uuid) }}", [1, 2, 3,
                4
            ],
            [{
                    data: "",
        ...
        initializeDataTable('#compensated-students-datatable', "{{ route('teacher.lessons.compensated', $lesson->uuid) }}",
            [1, 2, 3, 4, 5],
            [{
                    data: "",
                    orderable: false,
        ...
        initializeDataTable('#present-late-students-datatable',
            "{{ route('teacher.lessons.present_late', $lesson->uuid) }}", [1, 2, 3, 4, 5],
            [{
                    data: "",
                    orderable: false,
                    searchable: false
        ...
        initializeDataTable('#compensatory-students-datatable',
            "{{ route('teacher.lessons.compensatory', $lesson->uuid) }}", [1, 2, 3, 4, 5],
            [{
                    data: "",
                    orderable: false,
                    searchable: false
        ...
        initializeDataTable('#unrecorded-students-datatable', "{{ route('teacher.lessons.unrecorded', $lesson->uuid) }}", [
                1, 2, 3, 4, 5
            ],
            [{
                    data: "",
