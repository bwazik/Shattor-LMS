...
@section('content')
    ...
    <x-datatable datatableTitle="{{ trans('main.datatableTitle', ['item' => trans('admin/compensatories.compensatories')]) }} - {!! $lesson->title !!}"
...
@section('page-js')
    <script>
        initializeDataTable('#datatable', "{{ route('teacher.lessons.compensatories', $lesson->uuid) }}", [2, 3, 4, 5, 6],
            [
