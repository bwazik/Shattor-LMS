                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-2 row-gap-1">
                            <li class="breadcrumb-item">
                                <a
                                    href="{{ route('parent.help-center.index') }}">{{ trans('admin/helpCenter.helpCenter') }}</a>
                            </li>
                            <li class="breadcrumb-item">
                                <a
                                    href="{{ $article->category->articles->isNotEmpty() ? route('parent.help-center.show', [$article->category->slug, $article->category->articles->sortByDesc('published_at')->first()->slug]) : '#' }}">{{ $article->category->name }}</a>
                            </li>
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="list-unstyled mt-4 mb-0">
                        @forelse ($relatedArticles as $related)
                            <li class="mb-4">
                                <a href="{{ route('parent.help-center.show', [$related->category->slug, $related->slug]) }}"
