    ...
    <div class="col-md-12">
        <div class="nav-align-top">
            <ul class="nav nav-pills flex-column flex-sm-row mb-6 row-gap-2">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ isActiveRoute('parent.students.profile.quizzes') ? 'active' : '' }}"
                        href="{{ route('parent.students.profile.quizzes', $student->uuid) }}"><i
                ...
                <li class="nav-item">
                    <a class="nav-link {{ isActiveRoute('parent.students.profile.assignments') ? 'active' : '' }}"
                        href="{{ route('parent.students.profile.assignments', $student->uuid) }}"><i
                ...
                <li class="nav-item">
                    <a class="nav-link {{ isActiveRoute('parent.students.profile.security') ? 'active' : '' }}"
                        href="{{ route('parent.students.profile.security', $student->uuid) }}"><i
