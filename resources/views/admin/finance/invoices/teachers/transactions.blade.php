...
@section('content')
    ...
    <x-datatable datatableTitle="{{ trans('main.datatableTitle', ['item' => trans('admin/transactions.transactions')]) }} - {{ $invoice->teacher->name }} - {{ $invoice->subscription->plan->name }}">
        <th></th>
...
@section('page-js')
    <script>
        initializeDataTable('#datatable', "{{ route('admin.invoices.teachers.transactions', $invoice->id) }}", [2, 3, 4, 5, 6, 7],
            [
