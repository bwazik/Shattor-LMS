                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-6 gap-1">
                        <div class="me-1">
                            ...
                            <p class="mb-0">{{ trans('main.mr') }}: <span class="fw-medium text-heading"> {{ $assignment->teacher->name ?? 'N/A' }} </span></p>
                        </div>
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="d-flex justify-content-start align-items-center user-name">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <small>{{ trans('admin/teachers.teacher') }} {{ $assignment->teacher->subject->name ?? 'N/A' }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
