            ...
            <div class="card h-100">
                ...
                <div class="px-5 py-4 border border-start-0 border-end-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <small class="text-heading text-uppercase">{{ trans('admin/resources.percentage') }}</small>
                    </div>
                </div>
                <div class="card-body pt-5">
                    @foreach ($data['topStudents'] as $student)
                        <div class="d-flex justify-content-between align-items-center mb-6">
                            ...
                            <div class="text-end">
                                <h6 class="mb-0">{{ $student['percent_watched'] }}%</h6>
                            </div>
                        </div>
                    @endforeach
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            initializeDataTable('#students-viewed-datatable',
                "{{ route('admin.resources.studentsViewed', $resource->id) }}", [0, 1, 2],
                [{
                    data: "",
                    orderable: false,
                    searchable: false
            ...
            initializeDataTable('#students-not-viewed-datatable',
                "{{ route('admin.resources.studentsNotViewed', $resource->id) }}", [0, 1, 2],
                [{
                    data: "",
                    orderable: false,
                    searchable: false
