                    ...
                    <div class="p-2">
                        ...
                        <div class="ratio ratio-16x9 rounded overflow-hidden shadow-lg" style="border-radius: 16px;">
                            <iframe id="youtube-player"
                                ...
                                allowfullscreen referrerpolicy="strict-origin-when-cross-origin" class="rounded w-100" style="border-radius: 16px; height: 70vh;">
                            </iframe>
                        </div>
                        @endif
                        <hr class="my-6" />
                        ...
                        <div class="d-flex flex-wrap row-gap-2">
                            <div class="me-12">
                                <p class="text-nowrap mb-3">
                                    <i class="ri-calendar-schedule-line ri-20px me-2"></i>{{ trans('main.created_at')
                                    }}:
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <span class="text-nowrap overflow-hidden text-truncate" style="max-width: 200px;"
                                ...
                                <small class="text-body d-block">
                                    {{ $resource->file_size >= 1024 * 1024 ? number_format($resource->file_size / (1024
                                    * 1024), 2) . ' MB' : number_format($resource->file_size / 1024, 2) . ' KB' }}
                                </small>
                            </span>
                            <div class="ms-auto">
                                <button
